...
arg_parser.add_argument("--com", type=str, default="dev/ttyACM0", help="give the number of the COM port for STM32 Virtual Com Port")
...
def update_plot_data(new_roll_data, new_pitch_data, new_yaw_data, new_rollrate_data, new_pitchrate_data, new_yawrate_data):
    ...
    pitch_data.appendleft(new_pitch_data*RAD_TO_DEG_FACTOR)
